...
public class LabelDistanceTransform5x5ShortTest
{
	@Test
	public final void testDistanceMap_ChessBoard() 
	{
		...
		LabelDistanceTransform5x5Short algo = new LabelDistanceTransform5x5Short(weights, true);
	...
	public final void testDistanceMap_UntilCorners_CityBlock()
	{
		...
		LabelDistanceTransform5x5Short algo = new LabelDistanceTransform5x5Short(weights, false);
		ImageProcessor result = algo.distanceMap(image);
