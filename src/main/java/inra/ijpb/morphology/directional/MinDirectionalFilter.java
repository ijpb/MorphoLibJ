 ...
 *
 */
public class MinDirectionalFilter implements MorphologicalDirectionalFilter {
	...
	public MinDirectionalFilter(OrientedStrelFactory factory, int nTheta, Filters.Operation operation) {
