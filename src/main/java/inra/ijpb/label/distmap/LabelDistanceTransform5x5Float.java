...
public class LabelDistanceTransform5x5Float extends AlgoStub implements LabelDistanceTransform 
{
	 ...
	 */
	public LabelDistanceTransform5x5Float(ChamferWeights weights)
	{
	 ...
	 *            an array of two weights for orthogonal and diagonal directions
	 */
	public LabelDistanceTransform5x5Float(float[] weights)
	{
		this(weights, true);
	}
	 ...
	 */
	public LabelDistanceTransform5x5Float(ChamferWeights weights, boolean normalize)
	{
	 ...
	 *            normalized by the first weight
	 */
	public LabelDistanceTransform5x5Float(float[] weights, boolean normalize)
	{
