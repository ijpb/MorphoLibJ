 ...
 *
 */
public class LabelGeodesicDistanceTransform5x5FloatScanning extends AlgoStub
		implements LabelGeodesicDistanceTransform
{
	...
	public LabelGeodesicDistanceTransform5x5FloatScanning(ChamferWeights weights)
	{
		this(weights.getFloatWeights(), true);
	}

	public LabelGeodesicDistanceTransform5x5FloatScanning(ChamferWeights weights, boolean normalize)
	{
		this(weights.getFloatWeights(), normalize);
	}

	public LabelGeodesicDistanceTransform5x5FloatScanning(float[] weights)
	{
		this(weights, true);
	}

	public LabelGeodesicDistanceTransform5x5FloatScanning(float[] weights, boolean normalize)
	{
