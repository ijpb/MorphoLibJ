 ...
 * maps) within label images.
 *
 * @see inra.ijpb.label.distmap.LabelDistanceTransform
 * 
 * @author David Legland
 */
public interface LabelGeodesicDistanceTransform extends Algo
{
	/**
	 * Computes the geodesic distance transform (or geodesic distance map) of a
	 * binary image of marker, constrained to a label image.
	 * 
	 * @param marker
	 *            the binary image of marker
	 * @param mask
	 *            the label image of mask
