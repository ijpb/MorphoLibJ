 ...
 */
public class GrayscaleBoxDiameterOpeningPlugin implements ExtendedPlugInFilter, DialogListener 
{
	...
	public int setup(String arg, ImagePlus imp)
	{
		...
		if (arg.equals("final")) 
		{
			...
			String newName = imagePlus.getShortTitle() + "-boxDiagOpen";
    ...
    private void parseDialogParameters(GenericDialog gd) {
		...
		this.minDiagonalLength	= (int) gd.getNextNumber();
    }
