...
//		double[] perims = croftonPerimeter(labelImage, labels, resol, nDirs);
		...
		double[] areas = RegionMorphometry2D.areas(labelImage, labels, calib);
		double[] perims = RegionMorphometry2D.perimeters(labelImage, labels, calib, nDirs);
	 ...
	 * 
	 * @see inra.ijpb.measure.RegionMorphometry2D#areas(ImageProcessor, int[], Calibration)
	 * 
	 * @deprecated use {@link inra.ijpb.measure.RegionMorphometry2D#areas(ImageProcessor, int[], Calibration)} instead
	 * 
	 * @param image
	 *            the input image containing label of particles
	 * @param labels
	...
	public static final double[] area(ImageProcessor image, int[] labels,
		...
		return RegionMorphometry2D.areas(image, labels, calib);
	}
	 ...
	 * {@link inra.ijpb.measure.RegionMorphometry2D} class.
	 * 
	 * @deprecated replaced by {@link inra.ijpb.measure.RegionMorphometry2D}
	 *  
	 * @param image
	 *            the input image containing label of particles
	 * @param labels
			...
			int[] labels, double[] resol, int nDirs)
	{
		...
		return RegionMorphometry2D.perimeters(image, labels, calib, nDirs);
	}
			...
			int[] labels, double[] resol)
	{
		...
		return RegionMorphometry2D.perimeters(labelImage, labels, calib, 2);
	}
			...
			int[] labels, double[] resol)
	{
		...
		return RegionMorphometry2D.perimeters(labelImage, labels, calib, 4);
	}
