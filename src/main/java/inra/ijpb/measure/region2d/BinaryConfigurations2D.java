...
public class BinaryConfigurations2D
{
	 ...
	 */
	public static final int[] histogram(ImageProcessor binaryImage)
	{
		// initialize result
	...
	public static final int[] innerHistogram(ImageProcessor binaryImage)
	{
		// initialize result
		int[] histogram = new int[16];
	 ...
	 */
	public static final int[][] histograms(ImageProcessor labelImage, int[] labels)
	{
