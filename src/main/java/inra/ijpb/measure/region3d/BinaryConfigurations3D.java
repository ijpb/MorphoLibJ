...
/**
 * Utility functions for computing histograms of 2-by-2-by-2 binary
 * configurations within binary or label 3D images.
 * 
 * @author dlegland
 *
 */
...
public class BinaryConfigurations3D
{
	 ...
	 *         configurations
	 */
	public final static int[] histogram(ImageStack image)
	{   
		// Algorithm:
	 ...
	 *         configurations
	 */
	public final static int[] innerHistogram(ImageStack image)
	{   
		// Algorithm:
	 ...
	 */
	public final static int[][] histograms(ImageStack image, int[] labels)
	{   
		// Algorithm:
		// iterate on configurations of 2-by-2-by-2 voxels containing on voxel of 3D image. 
		// For each configuration, identify the labels within the configuration.
